...
foreach (var item in tableSizeArray)
{
    ...
    BenchmarTable<Person>(X => { new SortParallelWithProcesorParameter<Person>(20_000_000, 30, distanceSort).Sort(X); }, item, 5, () => Generator.GetPerson(), "multitreting, distanceSort");
